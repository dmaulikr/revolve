...
*/		
		redCircle = [CCSprite spriteWithFile:@"redcircle-2.png"];
		[redCircle setOpacity:0];
		[self addChild:redCircle z:3];
	
		greenCircle = [CCSprite spriteWithFile:@"greencircle-2.png"];
		[greenCircle setOpacity:0];
		[self addChild:greenCircle z:3];
		
		blueCircle = [CCSprite spriteWithFile:@"bluecircle-2.png"];
		[blueCircle setOpacity:0];
		[self addChild:blueCircle z:3];

		orangeCircle = [CCSprite spriteWithFile:@"orangecircleglow-2.png"];
		[orangeCircle setPosition:ccp(160,360)];
		[self addChild:orangeCircle z:5];
		
		orangeCircle2 = [CCSprite spriteWithFile:@"orangecircleglow-2.png"];
		[orangeCircle2 setPosition:ccp(160,160)];
		[self addChild:orangeCircle2 z:5];
		
		redSquare = [CCSprite spriteWithFile:@"redsquare-2.png"];
		[redSquare setOpacity:0];
		[redSquare setPosition:ccp(160,260)];
		[self addChild:redSquare z:4];
		
		greenSquare = [CCSprite spriteWithFile:@"greensquare-2.png"];
		[greenSquare setOpacity:0];
		[greenSquare setPosition:ccp(160,260)];
		[self addChild:greenSquare z:4];
		
		blueSquare = [CCSprite spriteWithFile:@"bluesquare-2.png"];
		[blueSquare setOpacity:0];
		[blueSquare setPosition:ccp(160,260)];
		[self addChild:blueSquare z:4];
		
		background = [CCSprite spriteWithFile:@"background-2.png"];
...
*/		
		backgroundLayer = [CCSprite spriteWithFile:@"backgroundlayer-2.png"];
		[backgroundLayer setAnchorPoint:ccp(.5,1)];
		[backgroundLayer setPosition:ccp(160,360)];
		[backgroundLayer setOpacity:0];
		[self addChild:backgroundLayer z:2];
		
		backgroundLayer2 = [CCSprite spriteWithFile:@"backgroundlayer-2.png"];
		[backgroundLayer2 setAnchorPoint:ccp(.5,1)];
		[backgroundLayer2 setPosition:ccp(160,160)];
...
*/
		brown1 = [CCSprite spriteWithFile:@"browncircle-2.png"];
		[brown1 setPosition:ccp(40,0)];
		[self addChild:brown1 z:1];
		brown2 = [CCSprite spriteWithFile:@"browncircle-2.png"];
		[brown2 setPosition:ccp(120,0)];
		[self addChild:brown2 z:1];
		brown3 = [CCSprite spriteWithFile:@"browncircle-2.png"];
		[brown3 setPosition:ccp(200,0)];
		[self addChild:brown3 z:1];
		brown4 = [CCSprite spriteWithFile:@"browncircle-2.png"];
		[brown4 setPosition:ccp(280,0)];
		[self addChild:brown4 z:1];

		// Load all sounds and start playing background music at volume 0
		[[SimpleAudioEngine sharedEngine] preloadBackgroundMusic:@"revolve2-base.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-red.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-green.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-blue.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve-miss.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-1.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-2.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"revolve2-3.m4a"];
		[[SimpleAudioEngine sharedEngine] preloadEffect:@"start.m4a"];
		[[SimpleAudioEngine sharedEngine] playBackgroundMusic:@"revolve2-base.m4a"];
		...
		if(userDefaults) {
			highScore = [userDefaults integerForKey:@"highScore2"];
		...
		[highScoreLabel setColor:ccc3(10,32,65)];
		...
		[endScoreLabel setColor:ccc3(10,32,65)];
		...
		[scoreDescLabel setColor:ccc3(10,32,65)];
		...
		[highScoreDescLabel setColor:ccc3(10,32,65)];
		...
		[menu setColor:ccc3(10,32,65)];
		[menu setPosition:ccp(160,80)];
		[menu setOpacity:0];
		[menu setIsTouchEnabled:NO];
		[self addChild:menu z:5];
		
		logo = [CCSprite spriteWithFile:@"smalllogo2.png"];
		[logo setOpacity:0];
...
*/
	...
	if(gameOver == YES) {
		if(counter == 2) {
			...
			if(score > highScore) {
				highScore = score;
				[userDefaults setInteger:highScore forKey:@"highScore2"];
		...
		if(squareCounter > 2) {
			...
			if(scoreMultiplier > 11) {
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-3.m4a"];
			} else if(scoreMultiplier > 5) {
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-2.m4a"];
			} else {
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-1.m4a"];				
			}
	...
	if(redCounter > (M_PI*4)) {
		redCounter = 0;
	}
	if(greenCounter > (M_PI*4)) {
		greenCounter = 0;
	}
	if(blueCounter > (M_PI*4)) {
		blueCounter = 0;
	}
 ...
 */
	if(redCounter < (M_PI*2)) {
		[redCircle setPosition:ccp(160 + cos(redPosition) * 100, 360 + sin(redPosition) * 100)];		
	} else {
		[redCircle setPosition:ccp(160 + cos(redPosition) * 100, 160 - sin(redPosition) * 100)];		
	}
	if(greenCounter < (M_PI*2)) {
		[greenCircle setPosition:ccp(160 + cos(greenPosition) * 100, 360 + sin(greenPosition) * 100)];		
	} else {
		[greenCircle setPosition:ccp(160 + cos(greenPosition) * 100, 160 - sin(greenPosition) * 100)];		
	}
	if(blueCounter < (M_PI*2)) {
		[blueCircle setPosition:ccp(160 + cos(bluePosition) * 100, 360 + sin(bluePosition) * 100)];		
	} else {
		[blueCircle setPosition:ccp(160 + cos(bluePosition) * 100, 160 - sin(bluePosition) * 100)];		
	}
...
-(void)checkCircleRange {
	...
	if(screenPushed == NO) {
		if(redCircle.position.y < 360 && redCircle.position.y > 160) {
			if(squareColor == 0) {
				score = score + [self calculateScore:redCircle.position.x];
				success = YES;
				screenPushed = YES;
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-red.m4a"];
		...
		if(greenCircle.position.y < 360 && greenCircle.position.y > 160) {
			if(squareColor == 1) {
				score = score + [self calculateScore:greenCircle.position.x];
				success = YES;
				screenPushed = YES;
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-green.m4a"];
		...
		if(blueCircle.position.y < 360 && blueCircle.position.y > 160) {
			if(squareColor == 2) {
				score = score + [self calculateScore:blueCircle.position.x];
				success = YES;
				screenPushed = YES;
				[[SimpleAudioEngine sharedEngine] playEffect:@"revolve2-blue.m4a"];
